...
//Sprawdzenie czy nasza przeglądarka obsługuje geolokalizacje
...
//Pobranie pozycji i utworzenie przycisku kierującego dalej na mapy binga
function geoSuccess(position) {
    ...
    $('.option').append("<a class='locButtonMap'>Nasza lokalizacja przedstawiona na mapie</a>");
